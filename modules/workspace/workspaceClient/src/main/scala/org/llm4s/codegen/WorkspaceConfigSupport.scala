...
object WorkspaceConfigSupport {
  ...
  private final case class WorkspaceSection(
    dir: Option[String],
    image: Option[String],
    port: Option[Int],
  ...
  private final case class WorkspaceRoot(workspace: Option[WorkspaceSection])

  private implicit val workspaceSectionReader: PureConfigReader[WorkspaceSection] =
    PureConfigReader.forProduct4("dir", "image", "port", "traceLogPath")(WorkspaceSection.apply)

  private implicit val workspaceRootReader: PureConfigReader[WorkspaceRoot] =
